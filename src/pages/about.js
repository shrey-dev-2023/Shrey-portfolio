...
const about = () => {
  return (
    <>
      <Head>
        <title>Shrey Khandelwal | About Page</title>
        <meta
          name="description"
            ...
            <div className="col-span-3 flex flex-col items-start justify-start
             xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                <strong className="text-primary dark:text-primaryDark">Hey! </strong>
                 My name is Shrey Khandelwal, a certified web developer and Graphic Designer
                with a passion for creating beautiful, functional, and
                user-centered digital experiences. With over 2 years of
                experience in this field. I am always looking for new and
              ...
              <p className="font-medium">
                ...
                forward to the opportunity to bring my skills and passion for the same.
              </p>
            </div>
