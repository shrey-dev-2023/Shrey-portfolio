  ...
  return(
    <motion.div 
        className="flex items-center justify-center rounded-full font-semibold
         bg-dark dark:bg-light dark:text-dark text-light py-3 px-6
          shadow-dark cursor-pointer absolute lg:p-6 md:p-4 lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3
    ...
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center
       rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh]
        ...
        <motion.div 
        className="flex items-center justify-center rounded-full font-semibold
         bg-dark dark:bg-light dark:text-dark text-light p-8
          shadow-dark cursor-pointer lg:p-6 md:p-4 xs:text-xs xs:p-2"
        whileHover={{scale: 1.05}}
        >
          Web
        </motion.div>
        <Skill name='HTML' x='-23.5vw' y='2vw' />
        ...
        <Skill name='Git' x='-40.5vw' y='-6vw' />
        <Skill name='Bootstrap' x='33vw' y='-18vw' />
        <Skill name='Adobe Illustrator' x='-25vw' y='18vw' />
        <Skill name='Adobe Photoshop' x='18vw' y='18vw' />
      </div>
    </>
  );
};
