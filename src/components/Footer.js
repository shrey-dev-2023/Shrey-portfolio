     ...
     text-lg dark:text-light dark:border-light sm:text-base'>
      <Layout className='py-8 flex items-center justify-between lg:flex-col lg:py-6'>
        ...
        <div className='flex items-center lg:py-2'>
           ...
           by&nbsp;<Link href='/about' className='underline underline-offset-2'>Shrey Khandelwal</Link>
        </div>
        <Link href="mailto:shrey.khandelwal.2000@gmail.com" target={'_blank'} className='underline underline-offset-2'>Say Hello</Link>
      </Layout>
    </footer>
  )
}
