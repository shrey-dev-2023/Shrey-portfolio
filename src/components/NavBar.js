    ...
    const handleClick = () => {
        ...
        return(
            <button href={href} className={`${className} relative group text-light dark:text-dark my-2`} onClick={handleClick}>
                ...
                <span className={`h-[1px] inline-block bg-light absolute left-0 
                -bottom-0.5 group-hover:w-full transition-[width] ease duration-300
...
<div className='w-full flex justify-between items-center lg:hidden'>
    ...
    <nav className='flex items-center justify-center flex-wrap'>
        ...
        <motion.a href='https://github.com/shrey-dev-2023' target={'_blank'}
        className='w-6 mx-3'
        whileHover={{y:-2}}
        whileTap={{scale: 0}}
        >
        ...
        <motion.a href='https://linkedin.com/in/shrey9659' target={'_blank'}
        className='w-6 mx-3'
        whileHover={{y:-2}}
        whileTap={{scale: 0}}
        >
        ...
        <motion.a href='https://dribbble.com/shots' target={'_blank'}
        className='w-6 ml-3'
        whileHover={{y:-2}}
        whileTap={{scale: 0}}
        >
